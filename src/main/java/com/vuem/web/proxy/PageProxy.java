...
public class PageProxy extends Proxy{
	/*
	 * private int totalCount, startRow, endRow, pageCount,pageNum, pageSize,
	 * startPage, endPage, blockCount, blockNum, nextBlock, prevBlock; private
	 * boolean existPrev, existNext; private String search; private final int
	 * BLOCK_SIZE = 5;
	 * 
	 * @Autowired Printer p;
	 */
	...
	/*
	 * public void paging() { Supplier<String> s = ()->
